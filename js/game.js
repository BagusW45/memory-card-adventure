...
class MemoryCardGame {
  ...
  setupEventListeners() {
    ...
    document
      ...
      .addEventListener("click", () => this.restartStage());
    document
      .getElementById("theme-btn")
      .addEventListener("click", () => this.showThemeModal());
    document
    ...
    document
      ...
      .addEventListener("click", () => this.hideThemeModal());
    document
      .getElementById("next-stage-btn")
      .addEventListener("click", () => this.nextStage());
    document
  ...
  startStage(stage) {
    ...
    this.updateCharacterMessage(
      `Stage ${stage}! Temukan ${
        this.stageConfigs[stage - 1].pairs
      } gambar yang sama!`
    );
  }
  ...
  generateCards() {
    ...
    const selectedIcons = this.shuffleArray([...themeIcons]).slice(
      0,
      config.pairs
    );
  ...
  showStageCompleteModal() {
    ...
    message.textContent = `Excellent! You completed stage ${
      this.currentStage
    }! Ready for stage ${this.currentStage + 1}?`;
